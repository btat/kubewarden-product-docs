...
{project-name}はlink:https://www.sigstore.dev/[Sigstore]プロジェクトのサポートを実装します。
...
{short-project-name}チームは、link:https://github.com/kubewarden/verify-image-signatures[検証ポリシー]を提供し、すべてのコンテナに対してSigstore署名を強制します。
