...
Con {project-name} 1.33, la función del Escáner de Auditoría guarda los informes en los CRDs de OpenReports de https://openreports.io[openreports.io] por defecto.
