...
Agora, precisamos escrever o código CEL que buscará os Ingresses existentes no cluster. Para isso, usamos a https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[biblioteca de extensão CEL {short-project-name}].
