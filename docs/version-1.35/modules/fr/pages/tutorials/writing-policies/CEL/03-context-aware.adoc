...
Maintenant, nous devons écrire le code CEL qui récupérera les Ingress existants dans le cluster. Pour cela, nous utilisons la https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{short-project-name}bibliothèque d'extensions CEL].
