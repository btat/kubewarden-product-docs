...
これを実現するために、ポリシーに含まれているlink:https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{short-project-name}のホスト機能のためのCEL拡張機能ライブラリ]を使用できます。
...
今、クラスター内の既存のIngressを取得するCELコードを書く必要があります。そのために、link:https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{short-project-name} CEL拡張機能ライブラリ]を使用します。
