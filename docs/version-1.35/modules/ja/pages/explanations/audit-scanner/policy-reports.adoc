...
{project-name}監査スキャナーを使用する際、link:https://openreports.io/[OpenReports]カスタムリソースを使用してポリシースキャンの結果を保存します。

[CAUTION]
====

{project-name} 1.33では、監査スキャナー機能がデフォルトでlink:https://openreports.io[openreports.io]のOpenReports CRDにレポートを保存します。
