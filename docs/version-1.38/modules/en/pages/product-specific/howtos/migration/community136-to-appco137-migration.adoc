...
= From {admc-community-name} 1.36 to {admc-name} 1.37
...
include::partial${build-type}-specific/backup-policies.adoc[]
...
include::partial${build-type}-specific/create-image-pull-secret.adoc[]
...
include::partial${build-type}-specific/verify-migration.adoc[]
...
include::partial${build-type}-specific/image-pull-secrets-caveat.adoc[]
