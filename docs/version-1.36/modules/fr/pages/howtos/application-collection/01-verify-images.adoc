...
:doc-type: ["howto"]
:keywords: ["{admc-name}", "rancher", "Collection d'Applications", "appco", "signature", "vérification", "vérifier"]
:sidebar_label: Vérifiez les images
:current-version: {page-origin-branch}

Cette section décrit comment vérifier les applications et les images de la https://apps.rancher.io/[Collection d'Applications Rancher] avec {admc-name}.
