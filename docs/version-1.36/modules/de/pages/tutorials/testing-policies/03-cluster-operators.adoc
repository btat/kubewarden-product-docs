...
Als Kubernetes-Cluster-Betreiber möchten Sie Tests für {admc-name} Richtlinien durchführen, die Sie verwenden möchten.
...
{admc-short-name} hat ein Dienstprogramm, https://github.com/kubewarden/kwctl[`kwctl`], das das Testen der Richtlinien außerhalb von Kubernetes ermöglicht.
...
Die {admc-short-name} Richtlinie kann von folgendem laden:
