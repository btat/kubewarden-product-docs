...
:doc-type: ["howto"]
:keywords: ["{admc-name}", "rancher", "anwendungssammlung", "appco", "signatur", "überprüfung", "verifizieren"]
:sidebar_label: Bilder überprüfen
:current-version: {page-origin-branch}

Dieser Abschnitt beschreibt, wie man Anwendungen und Bilder aus der https://apps.rancher.io/[Rancher-Anwendungssammlung] mit {admc-name} überprüft.
