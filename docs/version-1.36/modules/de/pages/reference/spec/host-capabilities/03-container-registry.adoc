...
OCI-Artefakte werden verwendet, um Objekte wie {admc-name} Richtlinien, Helm-Charts und mehr zu speichern.

Dies sind die Funktionen, die vom {admc-short-name} Host bereitgestellt werden, um mit Container-Registries zu interagieren.
...
Die Berechnung des Digests umfasst eine Reihe von Netzwerkanfragen zwischen dem {admc-short-name} Richtlinien-Host und der entfernten Registry.
Diese Operationen können zeitaufwendig sein, daher werden die Ergebnisse für 1 Minute zwischengespeichert.

=== Authentifizierung

Interaktionen mit privaten Registries erfordern, dass der {admc-short-name} Richtlinien-Host sich bei der entfernten Registry authentifiziert.
...
Das Abrufen dieser Informationen erfordert Netzwerkanfragen zwischen dem {admc-short-name} Richtlinien-Host und der entfernten Registry. Diese Operationen können zeitaufwendig sein, daher werden die Ergebnisse für 1 Minute zwischengespeichert.
...
Das Abrufen dieser Informationen erfordert Netzwerkanfragen zwischen dem {admc-short-name} Richtlinien-Host und dem entfernten Registry. Diese Operationen können zeitaufwendig sein, daher werden die Ergebnisse für 1 Minute zwischengespeichert.
