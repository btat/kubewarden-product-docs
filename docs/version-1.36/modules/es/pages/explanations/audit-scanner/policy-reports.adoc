...
:keywords: ["{admc-name}", “kubewarden”, “kubernetes”, “escáner de auditoría”, "informes-de-directivas"]
:sidebar_label: InformesDeDirectiva
:current-version: {page-origin-branch}

Al utilizar el Escáner de Auditoría {admc-name}, almacenas los resultados de los escaneos de directivas utilizando los Recursos Personalizados https://openreports.io/[OpenReports].

[CAUTION]
====

Con {admc-name} 1.33, la función del Escáner de Auditoría guarda los informes en los CRDs de OpenReports de https://openreports.io[openreports.io] por defecto.
...
{admc-short-name} incluye la interfaz de usuario del Policy Reporter con un filtro preconfigurado que solo muestra {admc-short-name} directivas, junto con información ampliada:
