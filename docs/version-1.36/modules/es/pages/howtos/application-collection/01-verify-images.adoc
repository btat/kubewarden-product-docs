...
:doc-type: ["howto"]
:keywords: ["{admc-name}", "rancher", "application collection", "appco", "signature", "verification", "verify"]
:sidebar_label: Verificar Imágenes
:current-version: {page-origin-branch}

Esta sección describe cómo verificar aplicaciones e imágenes de la https://apps.rancher.io/[Colección de Aplicaciones de Rancher] con {admc-name}.
