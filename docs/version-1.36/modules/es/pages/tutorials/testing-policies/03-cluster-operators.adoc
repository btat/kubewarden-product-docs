...
Como operador de clúster de Kubernetes, querrás realizar pruebas para las directivas {admc-name} que deseas utilizar.
...
{admc-short-name} tiene una utilidad, https://github.com/kubewarden/kwctl[`kwctl`], que permite probar las directivas fuera de Kubernetes.
...
La directiva {admc-short-name} puede cargar desde el:
