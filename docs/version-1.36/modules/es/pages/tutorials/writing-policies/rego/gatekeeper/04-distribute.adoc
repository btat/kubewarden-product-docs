...
= Distribuyendo una directiva de Gatekeeper con {admc-name}
...
Las directivas deben ser anotadas para que puedan ser enviadas y, eventualmente, ejecutadas por el {admc-name} `policy-server` en un clúster de Kubernetes.
