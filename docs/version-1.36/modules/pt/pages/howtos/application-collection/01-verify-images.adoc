...
:doc-type: ["howto"]
:keywords: ["{admc-name}", "rancher", "coleção de aplicativo", "appco", "assinatura", "verificação", "verificar"]
:sidebar_label: Verifique Imagens
:current-version: {page-origin-branch}

Esta seção descreve como verificar aplicativos e imagens da https://apps.rancher.io/[Coleção de Aplicativo do Rancher] com {admc-name}.
