...
= Distribuindo uma política do Gatekeeper com {admc-name}
...
As políticas precisam ser anotadas para que possam ser enviadas e, eventualmente, executadas pelo {admc-name} `policy-server` em um cluster Kubernetes.
