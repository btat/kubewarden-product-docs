...
Com {admc-short-name}, você pode verificar se a assinatura da política provém de usuários confiáveis e possui anotações específicas.
...
Este último exemplo testa se uma determinada política veio da organização {admc-short-name}:
