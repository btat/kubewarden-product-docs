...
Artefatos OCI são usados para armazenar objetos como {admc-name} políticas, charts Helm e mais.

Estas são as capacidades expostas pelo {admc-short-name} host para interagir com registros de contêiner.
...
Calcular o digest envolve uma série de requisições de rede entre o {admc-short-name} host de política e o registro remoto.
Essas operações podem ser custosas em termos de tempo, então os resultados são armazenados em cache por 1 minuto.

=== Autenticação

Interações com registros privados exigem que o {admc-short-name} host de política se autentique contra o registro remoto.
...
Buscar essa informação envolve requisições de rede entre o {admc-short-name} host de política e o registro remoto. Essas operações podem ser custosas em termos de tempo, então os resultados são armazenados em cache por 1 minuto.

=== Autenticação

Interações com registros privados requerem que o {admc-short-name} host de política se autentique contra o registro remoto.
...
Interações com registros privados requerem que o {admc-short-name} host de política se autentique no registro remoto.
